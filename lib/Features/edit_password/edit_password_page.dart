...
class EditPasswordPage extends StatefulWidget {
  ...
  EditPasswordPage({super.key, required this.account});
...
class _EditPasswordPageState extends State<EditPasswordPage> {
  ...
  void initState() {
    ...
    viewModel.accountNameController.text = widget.account.name;
    viewModel.linkController.text = widget.account.link;
    viewModel.emailController.text = widget.account.email;
    viewModel.passwordController.text = widget.account.password;
  }
